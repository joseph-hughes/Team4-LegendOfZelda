...
{
    class LinkDamagedAttackSouthState : IState
    {
        private Link link;
        private int sword_timer;
        private int damage_timer;

        public LinkDamagedAttackSouthState(Link link, int sword_timer, int damage_timer)
        {
            this.link = link;
            ...
            this.link.Sprite = PlayerSpriteFactory.Instance.CreateLinkDamagedSwordSouthSprite();
        }
