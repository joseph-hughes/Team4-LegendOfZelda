...
{
    class LinkDamagedAttackNorthState : IState
    {
        private Link link;
        private int sword_timer;
        private int damage_timer;

        public LinkDamagedAttackNorthState(Link link, int sword_timer, int damage_timer)
        {
            this.link = link;
            ...
            this.link.Sprite = PlayerSpriteFactory.Instance.CreateLinkDamagedSwordNorthSprite();
        }
        ...
        public void Update()
        {
            ...
            {
                link.LinkSwordRectangle = Rectangle.Empty;
                link.State = new LinkDamagedNonMovingNorthState(link, this.damage_timer);
            }
        }
