...
{
    class GotoRoom16Command : ICommand
    {
        private LegendOfZelda game;
        private const int COLUMN_NUM = 0;
        private const int ROW_NUM = 0;
        private int width = 0;
        private int height = 0;

        public GotoRoom16Command(LegendOfZelda game)
        {
            this.game = game;
        ...
        public void Execute()
        {
            ...
            game.gameState.RoomChange(game.level.Rooms[15]);
            game.level.CurrentRoom = game.level.Rooms[15];
        }
    }
}
