...
{
    class GotoRoom2Command : ICommand
    {
        ...
        public GotoRoom2Command(LegendOfZelda game)
        {
            this.game = game;
        ...
        public void Execute()
        {
            ...
            game.gameState.RoomChange(game.level.Rooms[1]);
            game.level.CurrentRoom = game.level.Rooms[1];
        }
    }
}
