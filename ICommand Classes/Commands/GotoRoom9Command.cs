...
{
    class GotoRoom9Command : ICommand
    {
        ...
        public GotoRoom9Command(LegendOfZelda game)
        {
            this.game = game;
        ...
        public void Execute()
        {
            ...
            game.gameState.RoomChange(game.level.Rooms[8]);
            game.level.CurrentRoom = game.level.Rooms[8];
        }
    }
}
