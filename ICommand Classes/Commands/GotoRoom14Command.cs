...
{
    class GotoRoom14Command : ICommand
    {
        ...
        public GotoRoom14Command(LegendOfZelda game)
        {
            this.game = game;
        ...
        public void Execute()
        {
            ...
            game.gameState.RoomChange(game.level.Rooms[13]);
            game.level.CurrentRoom = game.level.Rooms[13];
        }
    }
}
