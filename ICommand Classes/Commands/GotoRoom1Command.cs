...
{
    class GotoRoom1Command : ICommand
    {
        ...
        public GotoRoom1Command(LegendOfZelda game)
        {
            this.game = game;
        ...
        public void Execute()
        {
            ...
            game.gameState.RoomChange(game.level.Rooms[0]);
            game.level.CurrentRoom = game.level.Rooms[0];
        }
    }
}
